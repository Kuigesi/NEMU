...
opcode_entry opcode_table [512] = {
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, IDEX(ret_REL32, ret),
  ...
  /* 0xe8 */	IDEX(call_REL32, call), IDEX(J, jmp), EMPTY, IDEXW(J, jmp, 1),
  ...
  /* 0x20 */	IDEX(S2r, movCR), EMPTY, IDEX(r2S, movRC), EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(movb_E2G, movzx), IDEX(movw_E2G, movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(movb_E2G, movsx), IDEX(movw_E2G, movsx),
